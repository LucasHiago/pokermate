						...
						<?php foreach($aClubList as $aClub){ ?>
							<div class="c-h-item">
								<div class="panel panel-yellow" style="width:155px;height: 90px; margin-top: 5px;">
									...
									<div class="panel-body" style="text-align:center;">
										<a href="javascript:;" class="btn btn-primary" style="color: #fff; margin-top: -7px;" onclick="AlertWin.showFillSavecode1(this, <?php echo $aClub['id']; ?>, <?php echo $aClub['club_id']; ?>, '<?php echo $aClub['club_login_name']; ?>', '<?php echo $aClub['club_login_password']; ?>');">获取牌局</a>
									</div>
								</div>
							</div>
						<?php } ?>
