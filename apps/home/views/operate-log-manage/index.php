					...
					'data_json'	=>	[
						...
						'content' => function($aData){
							...
							if($aData['type'] == 1){
								...
								$log = date('Y.m.d', $aData['create_time']) . '   【修改联盟俱乐部对账方法】俱乐部名称：' . $aData['data_json']['aOldRecord']['club_name'] . ' 对账方法：' . ($aData['data_json']['aOldRecord']['duizhangfangfa'] == 1 ? '0.975' : ($aData['data_json']['aOldRecord']['duizhangfangfa'] == 3 ? '0.985' : '无水账单')) . '  修改后对账方法：' . ($aData['data_json']['aNewRecord']['duizhangfangfa'] == 1 ? '0.975' : ($aData['data_json']['aNewRecord']['duizhangfangfa'] == 3 ? '0.985' : '无水账单'));
