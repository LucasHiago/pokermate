	...
	public function getLianmengHostDuizhang($lianmengId){
		...
		foreach($aClubList as $aClub){
			...
			if(!$aClubZhangDanList[$aClub['club_id']]['club_is_clean']){
				$aClubZhangDanList[$aClub['club_id']]['club_zhang_dan_list'][$v['paiju_id']]['zhang_dan'] = -Calculate::calculateZhangDan($aClubZhangDanList[$aClub['club_id']]['club_zhang_dan_list'][$v['paiju_id']]['zhanji'], $aClubZhangDanList[$aClub['club_id']]['club_zhang_dan_list'][$v['paiju_id']]['baoxian_heji'], $aClubZhangDanList[$aClub['club_id']]['paiju_fee'], $aClubZhangDanList[$aClub['club_id']]['club_zhang_dan_list'][$v['paiju_id']]['baoxian_beichou'], $aClubZhangDanList[$aClub['club_id']]['club_zhang_dan_list'][$v['paiju_id']]['duizhangfangfa'], $this->choushui_shuanfa);
